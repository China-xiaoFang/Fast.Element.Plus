<p align="left">
	<strong>简体中文</strong> | <a href="https://gitee.com/FastDotnet/fast.element.plus.icons/blob/master/README.md">English</a>
</p>
...
详细说明见 [运行时契约](./runtime-contract)。

## 文档

- [API 参考](./api)
- [API reference](https://gitee.com/FastDotnet/fast.element.plus.icons/blob/master/docs/API.md)
- [运行时契约](./runtime-contract)
- [开发与发布指南](./development-release)
- [贡献指南](https://gitee.com/FastDotnet/fast.element.plus.icons/blob/master/CONTRIBUTING.md)
- [安全策略](https://gitee.com/FastDotnet/fast.element.plus.icons/blob/master/SECURITY.md)
- [更新日志](https://gitee.com/FastDotnet/fast.element.plus.icons/blob/master/CHANGELOG.md)
...
[Apache-2.0](https://gitee.com/FastDotnet/fast.element.plus.icons/blob/master/LICENSE)
