<p align="left">
	<strong>简体中文</strong> | <a href="https://gitee.com/FastDotnet/fast.vite.plugins/blob/master/README.md">English</a>
</p>
...
构建后可请求 `/meta/build-info.json`；开发服务器默认提供同名端点。源码中也可以导入 `virtual:fast-vite/build-info`，对应类型声明示例见 [API 文档](./api)。
...
- [完整 API 参考](./api)
- [风险指南](./risks)
- [拉取、开发、发布与部署](./development-release)
- [贡献指南](https://gitee.com/FastDotnet/fast.vite.plugins/blob/master/CONTRIBUTING.md)
- [工程质量审查](./engineering-review)
- [更新日志](https://gitee.com/FastDotnet/fast.vite.plugins/blob/master/CHANGELOG.md)
- [安全策略](https://gitee.com/FastDotnet/fast.vite.plugins/blob/master/SECURITY.md)
...
[Apache-2.0](https://gitee.com/FastDotnet/fast.vite.plugins/blob/master/LICENSE)
