...
export default defineConfig(
	...
	globalIgnores(
		...
		"fast-element-plus/ignores/global"
	),
	// 读取项目 `.gitignore`，补充仓库自己的忽略范围。
	{
		name: "fast-element-plus/ignores/git",
	...
	{
		name: "fast-element-plus/globals/browser",
	...
	{
		name: "fast-element-plus/globals/node-tooling",
		files: [
	...
	{
		name: "fast-element-plus/javascript",
	...
	{
		name: "fast-element-plus/typescript/type-checked",
	...
	{
		name: "fast-element-plus/typescript/tsx",
		files: ["**/*.tsx"],
		rules: {
	...
	{
		name: "fast-element-plus/sort/package-json",
		files: ["**/package.json"],
		/**
		 * package.json 属性排序规则。
		 *
	...
	{
		name: "fast-element-plus/sort/tsconfig",
	...
	// Vue 3 SFC 的类型感知脚本与模板规则，直接同步自 Fast.ESLint.Config。
	{
		name: "fast-element-plus/vue/type-checked",
		files: ["**/*.vue"],
		extends: [eslintJs.configs.recommended, ...tseslint.configs.recommendedTypeChecked, ...eslintPluginVue.configs["flat/recommended"]],
		languageOptions: {
			ecmaVersion: "latest",
	...
	{
		name: "fast-element-plus/vue/jsx",
		files: ["**/*.jsx"],
	...
	{
		name: "fast-element-plus/vue/tsx-type-checked",
		files: ["**/*.tsx"],
		plugins: { vue: eslintPluginVue },
		languageOptions: {
			ecmaVersion: "latest",
	...
	{
		name: "fast-element-plus/markdown",
		files: ["**/*.md"],
	...
	// 创建 Prettier 兼容层。
	{
		...
		name: "fast-element-plus/prettier",
	...
	{
		name: "fast-element-plus/node-tooling",
		files: [
			"**/.prettierrc.{js,cjs,mjs}",
			["**/*.{config,setup}.{js,cjs,mjs,jsx,ts,cts,mts,tsx}", "**/*.{js,cjs,mjs,jsx}"],
			["**/*.{config,setup}.{js,cjs,mjs,jsx,ts,cts,mts,tsx}", "**/*.{ts,cts,mts,tsx}"],
